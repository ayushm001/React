...
function Card({username, designation}) {
    ...
    <div className="mx-auto w-32 h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden">
        <img className="object-cover object-center h-32" src='https://th.bing.com/th/id/OIP.dvPzAHlp_Tttshx0Th7yiQHaHa?w=178&h=180&c=7&r=0&o=5&pid=1.7' alt='Woman looking front'></img>
    </div>
    <div className="text-center mt-2">
        <h2 className="font-semibold"> {username} </h2>
        <p className="text-gray-500">{designation}</p>
    </div>
    <ul classNamess="py-4 mt-2 text-gray-700 flex items-center justify-around">
        <li classNameass="flex flex-col items-center justify-around">
